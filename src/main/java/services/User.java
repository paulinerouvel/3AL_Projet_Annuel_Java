...
public class User {
    ...
    // Update a user (Put)
    public static Integer updateUser(models.User user) {
    ...
    public static Integer createUser(models.User user) {
        HttpURLConnection http = null;
    ...
    public static models.User jsonToUser(JSONObject user) {
    ...
    public static Integer notifyByMailUser(models.User user) {
        HttpURLConnection http = null;
        CloseableHttpClient client = null;
        URL url = null;
        try {
