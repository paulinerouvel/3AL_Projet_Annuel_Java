...
public class ListSuggestionsController extends GenericController {
    ...
    public void displayAddProduct() {
        try {
            ...
            StageManager.getInstance().loadExtraPageWithDetails(dotenv.get("SHARED_DETAILS_SUGGESTIONS"), detailList);
    ...
    public void displayModifyProduct() {
        try {
            refreshSelectedIndices();
